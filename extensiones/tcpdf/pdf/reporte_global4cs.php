...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="text-align: center; border: 1px solid #666; background-color:white; width:200px">
			...
			<td style="text-align: center; border: 1px solid #666; background-color:white; width:135px">
...
foreach ($respuestaGlobal as $key => $item) {
		...
		if ($not1 != 0 && $not2 == 0 && $not3 == 0 && $not4 == 0) {
				...
				$promedio1 = (number_format($not1) + number_format($not2)) / number_format(2);
				...
				$promedioFinal = "";
					...
					$promedio2 = (number_format($not3) + number_format($not4)) / number_format(2);
...
$bloque5 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="text-align: center; border: 1px solid #666; background-color:white; width:105px">
