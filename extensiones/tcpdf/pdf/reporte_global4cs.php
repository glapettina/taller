...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="text-align: center; border: 1px solid #666; background-color:white; width:200px">
			...
			<td style="text-align: center; border: 1px solid #666; background-color:white; width:136px">
...
$bloque5 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="text-align: center; border: 1px solid #666; background-color:white; width:102px">
			...
			<td style="text-align: center; border: 1px solid #666; background-color:white; width:34px">
