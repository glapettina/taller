              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg" name="nuevoPerfil">
                    ...
                    <option value="DocenteCB">Docente Ciclo Básico</option>
                    <option value="DocenteCSE">Docente Ciclo Superior Electro</option>
                    <option value="DocenteCSA">Docente Ciclo Superior Alimentación</option>
