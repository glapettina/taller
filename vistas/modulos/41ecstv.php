...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        4º Primera E TV - Ciclo Superior
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">4º Primera E TV - Ciclo Superior</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnListado" idCurso=24 tabla="sextoecs" informeGlobal="reporte_global4cs">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarNota4cs" tabla="sextoecs" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarNota"><i class="fa fa-pencil"></i></button>
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-success btnVerNota4cs" tabla="sextoecs" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalVerNota"><i class="fa fa-eye"></i></button>
                              
                            </div>

                             <div class="btn-group">
                                
                              <button class="btn btn-primary btnImprimirNota"  informe="reporte4cs" tabla="sextoecs" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirNota"><i class="fa fa-print"></i></button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <select class="form-control input-lg" name="editarPrimerBimestre" id="editarPrimerBimestre">
                              ...
                              <option value="Sistemas de Comandos y Maniobras">Sistemas de Comandos y Maniobras</option>
                              <option value="Prácticas Profesionalizantes">Prácticas Profesionalizantes</option>
         ...
         <?php
              ...
              $editarNota -> ctrEditarNota4cs($tabla,$curso);
