...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        3º Segunda E TV - Ciclo Superior
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">3º Segunda E TV - Ciclo Superior</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnListado" idCurso=22 tabla="quintoecs" informeGlobal="reporte_global3cs">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarNota2cs" tabla="quintoecs" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarNota"><i class="fa fa-pencil"></i></button>
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-success btnVerNota2cs" tabla="quintoecs" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalVerNota"><i class="fa fa-eye"></i></button>
                              
                            </div>

                             <div class="btn-group">
                                
                              <button class="btn btn-primary btnImprimirNota"  informe="reporte3cs" tabla="quintoecs" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirNota"><i class="fa fa-print"></i></button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <select class="form-control input-lg" name="editarPrimerBimestre" id="editarPrimerBimestre">
                              ...
                              <option value="Sistemas y Comandos">Sistemas y Comandos</option>
         ...
         <?php
              ...
              $editarNota -> ctrEditarNota3cs($tabla,$curso);
