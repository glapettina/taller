...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Quinto Año Electro - Ciclo Superior
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Quinto Año - Ciclo Superior</li>
      </ol>
    </section>
                  ...
                  foreach ($alumnos as $key => $value) {
                    ...
                    echo '<tr>
                          ...
                          if ($value["estado"] != 0) {
                            ...
                            echo '<td><button class="btn btn-success btn-xs btnActivar" tabla="quintoecs" idAlumno="'.$value["id"].'" estadoAlumno="0">Activado</button></td>';

                        }else{

                            echo '<td><button class="btn btn-danger btn-xs btnActivar" tabla="quintoecs" idAlumno="'.$value["id"].'" estadoAlumno="1">Desactivado</button></td>';
                        }
                          ...
                          echo '<td>
                            ...
                            <div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarAlumno" tabla="quintoecs" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarAlumno"><i class="fa fa-pencil"></i></button>

                              <button class="btn btn-danger btnEliminarAlumno" curso="5ecs" idAlumno="'.$value["id"].'"><i class="fa fa-times"></i></button>
